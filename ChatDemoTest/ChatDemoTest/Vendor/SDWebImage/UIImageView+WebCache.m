...
//add by liubo 1代表失败重试的策略
#define CachePolicy 1
...
- (void)sd_setImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder {
    ...
    //modify by liubo 2015/11/02
    [self sd_setImageWithURL:url placeholderImage:placeholder options:CachePolicy progress:nil completed:nil];
}
