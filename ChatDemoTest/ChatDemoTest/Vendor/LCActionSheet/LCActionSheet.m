...
- (void)setupMainView {
    ...
    if (self.buttonTitles.count) {
        ...
        for (int i = 0; i < self.buttonTitles.count; i++) {
            ...
            if (i == self.redButtonIndex) {
                ...
                titleColor = _redButtonColor ? _redButtonColor : LCColor(255, 10, 10);
    ...
    [cancelBtn setTitleColor:(_cancelTextColor != nil ? _cancelTextColor : _textColor) forState:UIControlStateNormal];
