...
+ (instancetype)mappingWithDictionary:(NSDictionary *)dic managerObjectContext:(NSManagedObjectContext *)context
{
    ...
    NSArray *properties = self.propertyListForCurrentClass;
    NSMutableDictionary *tmpDic = [NSMutableDictionary dictionaryWithObjects:properties forKeys:properties];
...
+ (NSArray *)propertyListForCurrentClass
{
