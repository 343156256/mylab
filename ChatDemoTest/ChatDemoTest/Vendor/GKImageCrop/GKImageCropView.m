...
- (UIImage *)croppedImage{
    ...
    UIGraphicsBeginImageContextWithOptions([self cropSize], NO, 0);
    
    CGFloat width = result.size.width;
    CGFloat height = result.size.height;
    CGFloat cWidth = self.cropSize.width;
    CGFloat cHeight = self.cropSize.height;
    CGFloat w = cWidth;
    CGFloat h = cHeight;
    ...
    CGFloat x = (w - cWidth) * 0.5f;
    CGFloat y = (h - cHeight) * 0.5f;
    
    [result drawInRect:CGRectMake(x, y, cWidth, cHeight)];
