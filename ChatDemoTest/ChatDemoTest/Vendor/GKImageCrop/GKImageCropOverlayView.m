...
- (void)drawRect:(CGRect)rect{
    ...
    if (heightSpan > 30 && (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPad)) {
        ...
        NSDictionary *attribute = [NSDictionary dictionaryWithObjectsAndKeys:pStyle, NSParagraphStyleAttributeName, [UIFont boldSystemFontOfSize:20], NSFontAttributeName, nil];
        [@"移动和缩放" drawWithRect:CGRectMake(10, (height - heightSpan) + (heightSpan / 2 - 20 / 2) , width - 20, 20) options:NSStringDrawingUsesLineFragmentOrigin attributes:attribute context:nil];
