...
// 导航栏标题的字体
#define RCBNavigationTitleFont [UIFont systemFontOfSize:19]
// 导航栏标题正常状态的颜色
#define RCBNavigationTitleColor_Normal [UIColor whiteColor]
// 导航栏标题不可用状态的颜色
#define RCBNavigationTitleColor_Disable [UIColor lightGrayColor]
...
+ (void)setupNavigationBarTheme
{
    ...
    textAttrs[NSForegroundColorAttributeName] = RCBNavigationTitleColor_Normal;
    // UITextAttributeFont  --> NSFontAttributeName(iOS7)
    textAttrs[NSFontAttributeName] = RCBNavigationTitleFont;
...
//    
    ...
    disableTextAttrs[NSForegroundColorAttributeName] = RCBNavigationTitleColor_Disable;
