...
@interface EaseMessageViewController ()<EaseMessageViewControllerDelegate,EaseMessageViewControllerDataSource>
{
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:KNOTIFICATION_MESSAGECHANGE object:nil];
}
