...
@interface EaseConversationListViewController ()<EaseConversationListViewControllerDataSource>
...
- (void)viewDidLoad {
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(tableViewDidTriggerHeaderRefresh) name:KNOTIFICATION_MESSAGECHANGE object:nil];
